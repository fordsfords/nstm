...
int main(int argc, char **argv)
{
  ...
  printf("%d nstm_get calls=%"PRIu64", raw=%"PRIu64", rt=%"PRIu64"\n",
      M, t4-t3, t4_raw-t3_raw, t4_rt-t3_rt);
  printf("%d nstm_get raw calls=%"PRIu64", raw=%"PRIu64", rt=%"PRIu64"\n",
      M, t5-t4, t5_raw-t4_raw, t5_rt-t4_rt);
  printf("%d nstm_get rt calls=%"PRIu64", raw=%"PRIu64", rt=%"PRIu64"\n",
